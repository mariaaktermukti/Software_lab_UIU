...
$results = mysqli_query( $connect, "SELECT * FROM teacher $where" ) or die("Query failed");
...
while( $rows = mysqli_fetch_array($results) ) {
    extract( $rows );   // creates $id, $dept, $name, $nid, $birth, $address
    echo "<tr>";
    echo "<td> $id </td>";
    echo "<td> $dept </td>";
    echo "<td> $name </td>";
    ...
    echo "<td> $birth </td>";
    echo "<td> $address </td>";
    echo "<td> <a href='updateTeacher.php?id=$id'>Update</a> | <a href='deleteTeacher.php?id=$id'>Delete</a> </td>";
    echo "</tr>";
}
